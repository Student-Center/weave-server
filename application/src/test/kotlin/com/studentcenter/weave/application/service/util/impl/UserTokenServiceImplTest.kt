...
class UserTokenServiceImplTest : DescribeSpec({
    ...
    describe("resolveRegisterToken") {
        ...
        context("회원가입 토큰을 파싱하여 유저정보가 있는 RegisterToken Claim객체를 반환한다") {
    ...
    describe("generateAccessToken") {
        ...
        context("유저정보를 토큰에 담아서 AccessToken을 생성한다") {
    ...
    describe("resolveAccessToken") {
        ...
        context("AccessToken을 파싱하여 유저정보가 있는 AccessToken Claim객체를 반환한다") {
    ...
    describe("generateRefreshToken") {
        ...
        context("유저정보를 토큰에 담아서 RefreshToken을 생성한다") {
    ...
    describe("resolveRefreshToken") {
        ...
        context("RefreshToken을 파싱하여 유저정보가 있는 RefreshToken Claim객체를 반환한다") {
